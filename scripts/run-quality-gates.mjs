...
function runQualityGates() {
  ...
  dimensions.push(commandDimension("lint_static_syntax", "ci_enforced", "node --check scripts/lib/cli-args.mjs && node --check scripts/check-cli-arg-normalization.mjs && node --check scripts/check-ci-workflow.mjs && node --check scripts/check-coverage.mjs && node --check scripts/check-dependency-licenses.mjs && node --check scripts/check-diff-hygiene.mjs && node --check scripts/check-format.mjs && node --check scripts/check-no-license-file.mjs && node --check scripts/check-package-metadata.mjs && node --check scripts/check-pr-metadata-public-safety.mjs && node --check scripts/check-public-safety.mjs && node --check scripts/check-target-guard.mjs && node --check scripts/serve-hmc.mjs && node --check scripts/serve-product-preview.mjs && node --check scripts/verify-hmc-state.mjs && node --check scripts/verify-product-preview.mjs && node --check scripts/verify-static-ui.mjs && node --check scripts/generate-supply-chain-artifacts.mjs && node --check scripts/reconcile-status.mjs && node --check scripts/run-quality-gates.mjs && node --check scripts/verify-evidence-manifest.mjs && node --check scripts/verify-quality-classification.mjs && node --check scripts/verify-source-manifest.mjs && node --check scripts/classify-source-authority.mjs && node --check scripts/verify-h03-schema-registry.mjs && node --check scripts/verify-h03-input-authority.mjs && node --check scripts/verify-h03-plan-normalization.mjs && node --check scripts/verify-h03-question-register.mjs && node --check scripts/verify-h03-delivery-constitution.mjs && node --check scripts/verify-h03-constitution-readiness.mjs && node --check scripts/verify-h03-ratification-readiness.mjs && node --check scripts/verify-h05-agent-registry.mjs && node --check scripts/verify-h05-capability-contracts.mjs && node --check scripts/verify-h05-circuit-breakers.mjs && node --check scripts/verify-h05-upskill-records.mjs && node --check scripts/verify-h05-agent-projection.mjs && node --check scripts/verify-h06-resource-quotas.mjs && node --check scripts/verify-h06-worktree-lifecycle.mjs && node --check scripts/verify-h06-locks-checkpoints-quarantine.mjs && node --check scripts/verify-h06-pod-scheduler.mjs && node --check scripts/verify-h06-local-lifecycle-runner.mjs"));
  ...
  dimensions.push(commandDimension("h05_upskill_decision_learning_records", "ci_enforced", "pnpm build && node scripts/verify-h05-upskill-records.mjs fixtures/h05-upskill-records/valid-config.json", {
    cannotClaim: [
      "stable_agents",
      "mechanically_independent_agents",
      "independent_quality_auditor_qualified",
      "runtime_upskill_enforcement",
      "structured_decision_upskill_fields_enforced_by_schema"
    ]
  }));
  dimensions.push(commandDimension("h05_hmc_agent_projection", "ci_enforced", "pnpm build && node scripts/verify-h05-agent-projection.mjs fixtures/h05-agent-projection/valid-config.json", {
    cannotClaim: [
      "stable_agents",
      "mechanically_independent_agents",
      "independent_quality_auditor_qualified",
  ...
  dimensions.push(commandDimension("h06_resource_quota_controller", "ci_enforced", "pnpm build && node scripts/verify-h06-resource-quotas.mjs fixtures/h06-resource-quotas/valid-config.json", {
    cannotClaim: [
  ...
  dimensions.push(commandDimension("h06_worktree_lifecycle", "ci_enforced", "pnpm build && node scripts/verify-h06-worktree-lifecycle.mjs fixtures/h06-worktree-lifecycle/valid-config.json", {
    cannotClaim: [
      "production_resource_orchestration",
      "mechanically_independent_agents",
      "stable_agents",
  ...
  dimensions.push(commandDimension("h06_locks_checkpoints_quarantine", "ci_enforced", "pnpm build && node scripts/verify-h06-locks-checkpoints-quarantine.mjs fixtures/h06-locks-checkpoints-quarantine/valid-config.json", {
    cannotClaim: [
      "production_resource_orchestration",
  ...
  dimensions.push(commandDimension("h06_pod_scheduler_serial_fallback", "ci_enforced", "pnpm build && node scripts/verify-h06-pod-scheduler.mjs fixtures/h06-pod-scheduler/valid-config.json", {
    cannotClaim: [
      "production_resource_orchestration",
      "live_autonomous_worktree_orchestration",
  ...
  dimensions.push(commandDimension("h06_local_lifecycle_runner_foundation", "ci_enforced", "pnpm build && node scripts/verify-h06-local-lifecycle-runner.mjs fixtures/h06-local-lifecycle-runner/valid-config.json", {
    cannotClaim: [
