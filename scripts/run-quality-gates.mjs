...
function runQualityGates() {
  ...
  dimensions.push(commandDimension("lint_static_syntax", "ci_enforced", "node --check scripts/lib/cli-args.mjs && node --check scripts/check-cli-arg-normalization.mjs && node --check scripts/check-ci-workflow.mjs && node --check scripts/check-coverage.mjs && node --check scripts/check-dependency-licenses.mjs && node --check scripts/check-diff-hygiene.mjs && node --check scripts/check-format.mjs && node --check scripts/check-no-license-file.mjs && node --check scripts/check-package-metadata.mjs && node --check scripts/check-pr-metadata-public-safety.mjs && node --check scripts/check-public-safety.mjs && node --check scripts/check-target-guard.mjs && node --check scripts/serve-hmc.mjs && node --check scripts/serve-product-preview.mjs && node --check scripts/verify-hmc-state.mjs && node --check scripts/verify-product-preview.mjs && node --check scripts/verify-static-ui.mjs && node --check scripts/generate-supply-chain-artifacts.mjs && node --check scripts/reconcile-status.mjs && node --check scripts/run-quality-gates.mjs && node --check scripts/verify-evidence-manifest.mjs && node --check scripts/verify-quality-classification.mjs && node --check scripts/verify-source-manifest.mjs && node --check scripts/classify-source-authority.mjs && node --check scripts/verify-h03-schema-registry.mjs && node --check scripts/verify-h03-input-authority.mjs && node --check scripts/verify-h03-plan-normalization.mjs && node --check scripts/verify-h03-question-register.mjs && node --check scripts/verify-h03-delivery-constitution.mjs && node --check scripts/verify-h03-constitution-readiness.mjs"));
