  ...
  try {
    ...
    const findings = [
      ...requireIncludes(html, [
        ...
        "H06 Worktree, Lock, Checkpoint, and Pod Scheduler",
        "H06_RUNTIME_LIFECYCLE_FOUNDATION_ACTIVE_FIXTURE_BACKED",
        "H02-F04-R1",
        "H03-F06",
        "H04-F06",
        "H05-F04",
      ...
      ...requireIncludes(js, ["setView", "aria-pressed", "state.fixture.json", "constitution-status", "h04-status", "h06-status"]),
