  ...
  try {
    ...
    const findings = [
      ...requireIncludes(html, [
        ...
        "H09 Self-Audit, Self-Heal, and Recovery",
        "H09_RECOVERY_PROJECTION_ACTIVE_FIXTURE_BACKED",
        "H02-F04-R1",
        "H03-F06",
        "H04-F06",
        "H05-F04",
      ...
      ...requireIncludes(js, ["setView", "aria-pressed", "state.fixture.json", "constitution-status", "h04-status", "h06-status", "h08-status", "h09-status"]),
      ...requireIncludes(stateJson, [
        "adapterMaturity",
        "fixture_backed",
        "H09-F05 HMC recovery projection",
        ...
        "H09_RECOVERY_PROJECTION_ACTIVE_FIXTURE_BACKED",
        "liveAutonomousRecovery",
        "productionRollbackExecuted",
        "fixture_projected",
        "derived_view_only"
      ])
    ];
